...
<ul id="menu-deroulant">
	<li><a class="m" href="samsung.php">Samsung</a>
		<ul>
            <?php 	
	...
	<li><a class="m" href="apple.php">Apple</a>
		<ul>
            <?php 	
            	ini_set('display_errors','off');
    			require "connect.php";   
    ...
    <li><a class="m" href="autres.php">Autres</a></li>
    <li><a class="m" href="accessoires.php">Accessoires</a></li>
    <li><a class="m" href="contact.php">Contact</a></li>
</ul>
</html>